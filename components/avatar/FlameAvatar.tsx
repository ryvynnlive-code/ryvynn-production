...
const STAGES = {
  ...
  2: { name: 'Spark', size: 64, color1: '#7e22ce', color2: '#c026d3', glow: 'rgba(192,38,211,0.25)', pulseScale: 1.05, pattern: 'seed-of-life' as const },
  3: { name: 'Flame', size: 80, color1: '#7e22ce', color2: '#d946ef', glow: 'rgba(192,38,211,0.35)', pulseScale: 1.08, pattern: 'seed-of-life' as const },
  4: { name: 'Blaze', size: 100, color1: '#c026d3', color2: '#9333ea', glow: 'rgba(147,51,234,0.4)', pulseScale: 1.1, pattern: 'flower-of-life' as const },
