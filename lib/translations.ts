...
export const translations = {
  en: {
    ...
    // ── Landing v2 (safety-first rewrite) ────────────────────────────────
    v2HeroTag: 'Anonymous · No memory · No tracking',
    v2HeroH1: "You're not alone right now.",
    v2HeroSub: "Say what's actually on your mind.",
    v2HeroSub2: 'No account. No memory. No one watching.',
    v2CtaMain: 'Start Talking — Nothing Saved',
    v2CtaDemo: 'Try the demo first',
    v2TrustAnon: 'Anonymous by default',
    v2TrustNoHistory: 'No chat history — ever',
    v2TrustNoTrack: 'No tracking or surveillance',
    v2TrustNotTherapy: 'Not therapy — real support, right now',
    v2DemoLabel: 'Try it. Type anything. Nothing is saved.',
    v2DemoPlaceholder: "Say what's on your mind...",
    v2DemoBtn: 'Send',
    v2DemoLoading: 'Listening...',
    v2DemoSessionNote: 'This conversation is not saved anywhere.',
    v2DemoContinueBtn: 'Continue in full Guardian →',
    v2DemoRestartBtn: 'Start over',
    v2SafeTag: 'Why people trust this',
    v2SafeH2: 'Built to be safe. Proven to stay that way.',
    v2SafeP: "Most AI apps store, train on, or sell your emotional data. RYVYNN can't — it's built to be structurally impossible.",
    v2SafeCard1Title: '100% anonymous',
    v2SafeCard1Desc: 'No account required. No name, email, or phone. Nothing tied to you.',
    v2SafeCard2Title: 'Zero memory',
    v2SafeCard2Desc: "Close the tab and it's gone. Forever. Not archived, not logged, not anywhere.",
    v2SafeCard3Title: 'Not therapy',
    v2SafeCard3Desc: "We're not a therapist or hotline. We're the place you go when you need to say it out loud first.",
    v2HowTag: 'How it works',
    v2HowH2: 'Three steps. No setup.',
    v2HowStep1: 'Open and type',
    v2HowStep1Desc: 'No signup. No intro. Just say what you need to say.',
    v2HowStep2: 'RYVYNN responds',
    v2HowStep2Desc: 'Calm, grounded, present. No judgment. No scripts.',
    v2HowStep3: 'Close. It\'s gone.',
    v2HowStep3Desc: 'Zero trace. Your words vanish the second you leave.',
    v2ProofTag: 'What people say',
    v2ProofH2: 'Real moments. Real 3 AM.',
    v2WhoTag: 'This is for you if...',
    v2WhoH2: "You don't need to explain yourself to be here.",
    v2Who1: "You need to say something you can't say to anyone else",
    v2Who2: "Therapy waitlists are months long and the spiral is now",
    v2Who3: "You've been burned by apps that remember too much",
    v2Who4: "You just need somewhere to put it, without it following you",
    v2Who5: "You're in recovery and need zero-judgment space",
    v2Who6: "You're holding it together for everyone else",
    v2PricingTag: 'Pricing',
    v2PricingH2: 'Free when you need it.',
    v2PricingH2b: "More when you're ready.",
    v2PricingSub: 'Crisis access is free forever. No card. No catch.',
    v2PricingFreeName: 'Free',
    v2PricingFreeSub: 'Always. No card needed.',
    v2PricingFreeCta: 'Start for free',
    v2PricingSoloName: 'Solo',
    v2PricingSoloPrice: '$12.12/mo',
    v2PricingSoloFirstMonth: 'First month $3.69',
    v2PricingSoloCta: 'Get started',
    v2PricingNote: 'All plans · Cancel anytime · Crisis tier free forever, no exceptions.',
    v2FinalH2: "You've held it long enough.",
    v2FinalSub: 'No pressure. No account. No one watching. Just a place to put it down.',
    v2FinalCta: "I'm Listening — Talk Now",
    v2FinalOr: 'or',
    v2FinalDemoLink: 'try the demo first',
    v2FooterLegal: 'RYVYNN is not a licensed therapist or crisis service. AI responses do not constitute medical advice.',
    v2FooterEmergency: 'If you are in danger: call 988 (US) or local emergency services.',
    v2FooterCopy: '© 2026 AONIXX, a DBA of NEXXT GEN INNOVATIONS LLC',
    v2FloatBtn: 'Talk now — nothing saved',
    v2AgeNotice: "This space contains unfiltered discussions of trauma, addiction and crisis. If you're under 18, please come back later.",
    v2AgeDismiss: 'I understand, continue',
  ...
  es: {
    ...
    // ── Landing v2 (safety-first rewrite) ────────────────────────────────
    v2HeroTag: 'Anónimo · Sin memoria · Sin rastreo',
    v2HeroH1: 'No estás solo en este momento.',
    v2HeroSub: 'Di lo que realmente tienes en mente.',
    v2HeroSub2: 'Sin cuenta. Sin memoria. Sin nadie mirando.',
    v2CtaMain: 'Empieza a hablar — Nada se guarda',
    v2CtaDemo: 'Prueba el demo primero',
    v2TrustAnon: 'Anónimo por defecto',
    v2TrustNoHistory: 'Sin historial de chat — nunca',
    v2TrustNoTrack: 'Sin rastreo ni vigilancia',
    v2TrustNotTherapy: 'No es terapia — apoyo real, ahora mismo',
    v2DemoLabel: 'Pruébalo. Escribe lo que sea. Nada se guarda.',
    v2DemoPlaceholder: 'Di lo que tienes en mente...',
    v2DemoBtn: 'Enviar',
    v2DemoLoading: 'Escuchando...',
    v2DemoSessionNote: 'Esta conversación no se guarda en ningún lugar.',
    v2DemoContinueBtn: 'Continuar en el Guardián completo →',
    v2DemoRestartBtn: 'Empezar de nuevo',
    v2SafeTag: 'Por qué la gente confía en esto',
    v2SafeH2: 'Diseñado para ser seguro. Probado para mantenerse así.',
    v2SafeP: 'La mayoría de las apps de IA almacenan, entrenan o venden tus datos emocionales. RYVYNN no puede — es estructuralmente imposible.',
    v2SafeCard1Title: '100% anónimo',
    v2SafeCard1Desc: 'Sin cuenta requerida. Sin nombre, email ni teléfono. Nada vinculado a ti.',
    v2SafeCard2Title: 'Cero memoria',
    v2SafeCard2Desc: 'Cierra la pestaña y desaparece. Para siempre. Sin archivar, sin registrar, en ningún lugar.',
    v2SafeCard3Title: 'No es terapia',
    v2SafeCard3Desc: 'No somos terapeuta ni línea de crisis. Somos el lugar al que vas cuando necesitas decirlo en voz alta primero.',
    v2HowTag: 'Cómo funciona',
    v2HowH2: 'Tres pasos. Sin configuración.',
    v2HowStep1: 'Abre y escribe',
    v2HowStep1Desc: 'Sin registro. Sin introducción. Solo di lo que necesitas decir.',
    v2HowStep2: 'RYVYNN responde',
    v2HowStep2Desc: 'Calmo, centrado, presente. Sin juicio. Sin guiones.',
    v2HowStep3: 'Cierra. Desaparece.',
    v2HowStep3Desc: 'Sin rastro. Tus palabras desaparecen en el momento en que te vas.',
    v2ProofTag: 'Lo que dice la gente',
    v2ProofH2: 'Momentos reales. Las 3 AM reales.',
    v2WhoTag: 'Esto es para ti si...',
    v2WhoH2: 'No necesitas explicarte para estar aquí.',
    v2Who1: 'Necesitas decir algo que no puedes decirle a nadie más',
    v2Who2: 'Las listas de espera son meses y la espiral es ahora',
    v2Who3: 'Has sido quemado por apps que recuerdan demasiado',
    v2Who4: 'Solo necesitas un lugar donde ponerlo, sin que te siga',
    v2Who5: 'Estás en recuperación y necesitas un espacio sin juicio',
    v2Who6: 'Estás aguantando por todos los demás',
    v2PricingTag: 'Precios',
    v2PricingH2: 'Gratis cuando lo necesitas.',
    v2PricingH2b: 'Más cuando estés listo.',
    v2PricingSub: 'El acceso en crisis es gratis para siempre. Sin tarjeta. Sin trampa.',
    v2PricingFreeName: 'Gratis',
    v2PricingFreeSub: 'Siempre. Sin tarjeta.',
    v2PricingFreeCta: 'Empezar gratis',
    v2PricingSoloName: 'Solo',
    v2PricingSoloPrice: '$12.12/mes',
    v2PricingSoloFirstMonth: 'Primer mes $3.69',
    v2PricingSoloCta: 'Comenzar',
    v2PricingNote: 'Todos los planes · Cancela cuando quieras · Nivel de crisis gratis para siempre.',
    v2FinalH2: 'Ya has aguantado suficiente.',
    v2FinalSub: 'Sin presión. Sin cuenta. Sin nadie mirando. Solo un lugar donde dejarlo.',
    v2FinalCta: 'Estoy Escuchando — Habla Ahora',
    v2FinalOr: 'o',
    v2FinalDemoLink: 'prueba el demo primero',
    v2FooterLegal: 'RYVYNN no es un terapeuta ni servicio de crisis con licencia. Las respuestas de IA no constituyen consejo médico.',
    v2FooterEmergency: 'Si estás en peligro: llama al 988 (EE.UU.) o servicios de emergencia locales.',
    v2FooterCopy: '© 2026 AONIXX, DBA de NEXXT GEN INNOVATIONS LLC',
    v2FloatBtn: 'Habla ahora — nada se guarda',
    v2AgeNotice: 'Este espacio contiene conversaciones sin filtrar sobre trauma, adicción y crisis. Si tienes menos de 18 años, vuelve más tarde.',
    v2AgeDismiss: 'Entiendo, continuar',
